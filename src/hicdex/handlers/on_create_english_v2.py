...
from hicdex.types.objktbid_english2.parameter.create_auction import CreateAuctionParameter

hashids = Hashids(salt='objkt.bid2!', min_length=8)


async def on_create_english_v2(
    ctx: HandlerContext,
    create_auction: Transaction[CreateAuctionParameter, ObjktbidEnglish2Storage],
) -> None:
